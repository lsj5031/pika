...
```bash
curl -I https://pi.liu.nz | grep -i strict-transport-security
```
...
# PIKA_NPX_PATH=/home/leo/.nvm/versions/node/v22.18.0/bin/npx
```
...
- Verify `CORS_ALLOWED_ORIGINS=https://pi.liu.nz`
